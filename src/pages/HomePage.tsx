...
const HomePage = () => {
  ...
  const LoadingSkeleton = () => (
    <div className="animate-pulse space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="h-48 bg-gray-200 rounded hidden md:block"></div>
      </div>
    </div>
  );
  ...
  const BlogCard = ({ blog }: { blog: any }) => (
    <Card className="overflow-hidden border-primary/10 hover:shadow-md transition-shadow rounded-lg bg-card h-full flex flex-col">
      <CardHeader className="pb-2 border-b border-primary/5">
        ...
        <CardTitle className="text-xl md:text-2xl font-serif hover:text-primary/90 transition-colors line-clamp-2">
    ...
    <div className="w-full">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12 bg-muted/30 rounded-xl shadow-sm max-w-4xl mx-auto">
            {searchTerm ? (
              <>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            {featuredBlog && !searchTerm && !filterTag && (
              <div className="mb-12">
                <h2 className="text-2xl font-serif font-bold mb-4">Featured Post</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 xl:gap-8">
              {filteredBlogs
                .filter(blog => !searchTerm && !filterTag ? blog.id !== featuredBlog?.id : true)
                .map((blog) => (
